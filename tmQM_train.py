...
def main(config,predata=None):
    dataset = tmQM_wrapper(config['path'],config['batch_size'],predata=predata,**config['data'])
...
if __name__ == "__main__":
    ...
    task_list1 = ['GAT_homo_1_4_xyz_raw_attention16','GAT-v2_homo_1_4_xyz_raw_attention16','MPNN_homo_1_4_xyz_raw_attention16']
    task_list2 = ['MPNN_homo_1_4_DG_raw_attention64']
    task_list3 = ['GCN_homo_4_0_xyz_raw_attention16','GIN_homo_4_0_xyz_raw_attention16','GraphSAGE_homo_4_0_xyz_raw_attention16']
    task_list4 = ['MLHGT-MPNN_heter_4_0_laplace_raw_cat','MLHGT-MPNN_heter_4_0_laplace_raw_attention16']
    task_list5 = ['GAT_homo_1_4_DG_round_attention16_1','GAT-v2_homo_1_4_DG_round_attention16_1','MPNN_homo_1_4_DG_round_attention16_1']
    task_list6 = ['MPNN_homo_1_1_xyz_raw_attention16_1_interprate']
    ...
    if config['experiment']['name'] == 'test':
        ...
        for task in task_list:
            ...
            if task_config[1] == 'homo':
                config['data']['heter'] = False                      
            else:
                config['data']['heter'] = True
            ...
            if task_config[5] == 'round':
                config['data']['ORound'] = True
            else:
                config['data']['ORound'] = False
            ...
            if len(task_config) == 8:
                config['GNN']['mp'] = int(task_config[7])
            ...
            print('Generate datasets......\n')
            predata = tmQM_dataset(config['path'],
                                   heter=config['data']['heter'],
                                   pe=config['data']['pe'],
                                   round=config['data']['ORound'],
                                   label_index=config['data']['label_index'])
